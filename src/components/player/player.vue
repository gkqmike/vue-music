          ...
          <scroll class="middle-r" ref="lyricList" :data="currentLyric && currentLyric.lines">
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p ref="lyricLine" class="text" v-for="(line,index) in currentLyric.lines" :class="{'current': currentLineNum === index}">
                  {{line.txt}}
                </p>
              </div>
            </div>
        ...
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar :precent="precent" @percentChange="onPercentChange" @percentMove="onPercentMove"></progress-bar>
            </div>
...
import Lyric from 'lyric-parser/src/index.js'
...
export default {
  ...
  methods: {
    ...
    middleTouchMove(e) {
      ...
      let offsetWidth = Math.max(-innerWidth, Math.min(left + deltaX, 0))
    ...
    middleTouchEnd() {
      ...
      this.$refs.lyricList.$el.style[transform] = `translateX(${translateX}px)`
